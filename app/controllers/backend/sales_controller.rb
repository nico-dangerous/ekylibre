    ...
    def show
      ...
      respond_with(@sale, methods: [:taxes_amount, :affair_closed, :client_number, :sales_conditions, :sales_mentions, :pretax_amount_by_working_area],
                          include: { address: { methods: [:mail_coordinate] },
                                     ...
                                     items: { methods: [:taxes_amount, :tax_name, :tax_short_label, :pretax_amount_by_working_area], include: {
                                       variant: { methods: {}, include: :category },
                                       parcel_items: { include: [:product, :parcel] }
                                     } } }) do |format|
        format.html do
